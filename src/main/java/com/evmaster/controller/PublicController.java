...
/**
 * Controller providing public, unauthenticated access to system data
 * such as all available charging stations for the map viewer.
 */
@RestController
...
public class PublicController {
    ...
    /**
      Return stations WITH chargers using JOIN FETCH query
     Return DTO to avoid lazy loading + recursion problems
     */
    @GetMapping("/stations")
    ...
    private ChargingStationDTO toDTO(ChargingStation s) {
        ...
        dto.setRating(4.0); // TODO: calculate from Review table later

        //  ALWAYS return chargers list (never null)
